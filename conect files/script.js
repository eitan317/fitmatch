...
function openTrainerEdit(trainerId) {
    ...
    window.location.href = "edit-trainer.html";
}
...
// Trainer registration is now handled inline in register.html
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (path.includes("register.html")) {
        ...
        return;
    } else if (path.includes("trainer-profile.html")) {
        initTrainerProfilePage && initTrainerProfilePage();
    }
    
    // Note: initAdminPage() is now called via onload in admin.html
