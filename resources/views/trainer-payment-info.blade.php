        ...
        <div class="form-container">
            <div class="form-card">
                <div style="text-align: center; margin-bottom: 2rem;">
                    <div style="font-size: 4rem; margin-bottom: 1rem; color: #ffc107;">
                ...
                <div style="background: rgba(255, 193, 7, 0.1); padding: 2rem; border-radius: 16px; margin-bottom: 2rem; border: 2px solid rgba(255, 193, 7, 0.3);">
                    <h2 style="color: #ffc107; margin-bottom: 1.5rem; font-size: 1.5rem; text-align: center;">
                        <i class="fas fa-money-bill-wave"></i>
                        פרטי תשלום
                    </h2>
                    
                    <div style="background: rgba(255, 255, 255, 0.05); padding: 2rem; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.1); margin-bottom: 1.5rem;">
                            ...
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 1rem; background: rgba(255, 255, 255, 0.05); border-radius: 8px;">
                                <div style="display: flex; align-items: center; gap: 1rem;">
                                    ...
                                    <div>
                                        ...
                                        <div style="color: var(--primary); font-size: 1.3rem; font-weight: bold;">0527020113</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Status Info -->
                <div style="background: rgba(255, 193, 7, 0.15); padding: 1.5rem; border-radius: 12px; border-right: 4px solid #ffc107; margin-bottom: 2rem;">
                    <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div style="text-align: center;">
                    ...
                    <a href="{{ route('trainers.edit', $trainer) }}" class="btn btn-primary" style="margin: 0.5rem;">
